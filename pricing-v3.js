...
window.getBannerTotalUnit = function(productID, options = {}, legacyTurnVal = "0", legacyHemType = null, legacyPocketType = null) {
    ...
    try {
        ...
        // Individual banner calculators use the product's MATERIAL rate from MongoDB.
        // startingPrice is reserved for the category/listing card ("Price starts at").
        // This keeps the two MongoDB fields explicit and predictable.
        let totalSqFtWholesale = Number(product.material || 0);
